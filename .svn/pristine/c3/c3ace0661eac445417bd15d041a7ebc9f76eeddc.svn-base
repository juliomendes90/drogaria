...
public class ProdutoBean implements Serializable {
	...
	private static final long serialVersionUID = -8075485332054052441L;
	...
	public void salvar() {
		try {
			...
			Path destino = Paths.get("C:/Users/jcmorais/Desktop/jcmorais/Programação Web com Web/Uploads/" + produtoRetorno.getCodigo() + ".png");
